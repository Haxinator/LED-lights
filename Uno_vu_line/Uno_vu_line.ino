...
# define RIGHT_OUT_PIN 14            // Right channel data out pin to LEDs [5]
# define LEFT_IN_PIN 34             // Left aux in signal [A5]
# define RIGHT_IN_PIN 35            // Right aux in signal [A4]
# define BTN_PIN 13                  // Push button on this pin [3]
...
# define N_PIXELS 50                // Number of pixels in each string [24]
